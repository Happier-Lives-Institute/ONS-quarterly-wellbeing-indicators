...
my_sheets_NW <-  c(
  ...
  # "7.4_Human_capital",
  "7.5_Satisfac'n_with_edu_skills",
  "7.6_Satisfact'n_with_edu_system",
...
dat_NW <- dat_NW %>% 
  mutate(
    variable = ifelse(variable == "Satisfaction social r'ships", "Satisfaction with social relationships", variable), 
    descriptor = case_when(
      ...
      variable == "Satisfaction with education skills" ~ "Fairly or very satisfied with their education and skills",
